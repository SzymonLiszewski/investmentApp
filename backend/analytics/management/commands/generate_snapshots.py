...
Usage:
    # Generate snapshots for yesterday (default daily job)
    python manage.py generate_snapshots

    # Generate for a specific date
    python manage.py generate_snapshots --date 2026-01-15

    # Backfill all missing snapshots from first transaction to today
    python manage.py generate_snapshots --backfill
"""
    ...
    def handle(self, *args, **options):
        ...
        for user in users:
            ...
            try:
                ...
                self.stdout.write(f"  ✓ {len(snapshots)} snapshot(s)")
