...
from analytics.services.data_fetchers import (
    CryptoDataFetcher,
    StockDataFetcher,
...
class PortfolioSnapshotService:
    ...
    def __init__(
        ...
        self.stock_data_fetcher = stock_data_fetcher or YfinanceStockDataFetcher()
        self.crypto_data_fetcher = crypto_data_fetcher or YfinanceCryptoDataFetcher()
